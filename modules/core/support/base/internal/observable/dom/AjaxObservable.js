...
var ancientInternetExplorerProgIDs = ['Msxml2.XMLHTTP', 'Microsoft.XMLHTTP', 'Msxml2.XMLHTTP.4.0'];
function getXMLHttpRequest() {
    if (XMLHttpRequest) {
        return new XMLHttpRequest();
    }
    else if (typeof ActiveXObject === 'function') {
        for (var _i = 0, ancientInternetExplorerProgIDs_1 = ancientInternetExplorerProgIDs; _i < ancientInternetExplorerProgIDs_1.length; _i++) {
            var progId = ancientInternetExplorerProgIDs_1[_i];
            try {
                var axoXHR = new ActiveXObject(progId);
                if (axoXHR) {
                    return axoXHR;
                }
            }
