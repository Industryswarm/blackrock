 ...
 *
 * @private
 * @class Server.Libraries.EventEmitter2
 * @ignore
 *
 * @description
...
!function() {
  ...
  EventEmitter.prototype.configNow = function(conf) {
    this._events = {};
  ...
  function searchListenerTree(handlers, type, tree, i) {
    ...
    let listeners=[]; let leaf; let len; let branch; let xTree; let xxTree; let isolatedBranch; let endReached;
    const typeLength = type.length; const currentType = type[i]; const nextType = type[i+1];
